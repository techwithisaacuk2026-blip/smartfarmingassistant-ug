...
const SYSTEM_PROMPT = `You are a helpful Smart Farming Assistant for small-scale farmers in Uganda. 
...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Processing farming assistant request with", messages.length, "messages");
